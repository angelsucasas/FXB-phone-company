 ...
 * @author Moisés
 */
public class ListadoE extends javax.swing.JFrame {
    ...
    public ListadoE(NumeracionXml num) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("ƒastHost");
    ...
    private void initComponents() {
        ...
        jLabel1.setPreferredSize(new java.awt.Dimension(1050, 580));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
